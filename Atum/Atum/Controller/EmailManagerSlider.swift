...
class EmailManagerSlider: NSObject {
    ...
    lazy var addTextInfoField: PostcardImageInfoField = {
        ...
        addTextInfoField.backgroundColor = UIColor(named: .iconColor)
    ...
    func presentSlider() {
        ...
        if let window = window {
            ...
            NSLayoutConstraint.activate([
                ...
                addTextInfoField.heightAnchor.constraint(equalToConstant: 31),//Constant.emailInputFieldHeight),
                
                addTextSwitch.centerYAnchor.constraint(equalTo: addTextInfoField.centerYAnchor, constant: 4.5),
...
extension EmailManagerSlider: UITextFieldDelegate {
...
extension EmailManagerSlider: MFMailComposeViewControllerDelegate {
