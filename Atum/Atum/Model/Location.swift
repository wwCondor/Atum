...
struct Location {
    ...
    static let colosseum: Location          = Location(locationName: "Colloseum",               latitude: "41.8902",    longitude: "12.4922") // 5
    ...
    static let chineseWall: Location        = Location(locationName: "Chinese Wall",            latitude: "40.4319",    longitude: "116.5704") // 10
    ...
    static let northernLight: Location      = Location(locationName: "Northern Light",          latitude: "64.8378",    longitude: "-147.7164") // 15
